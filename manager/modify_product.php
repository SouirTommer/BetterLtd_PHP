  ...
  <div class="wrapper">
    ...
    <div class="main_content">
      <div class="topbar">
        ...
        <div class="header" style="padding: 6px 14px;">Edit product (ItemID: <?php echo($itemID); ?>)</div>
        ...
        <div class="container text-center">
          <div class="row">
            <div class="col-md-12">
              ...
              <form action="Action/modify_product_action.php" method="post">

              <div class="form-group row">
                  <label for="itemID" class="col-sm-2 col-form-label">Item ID</label>
                  <div class="col-sm-10">
                    <input id="itemID" readonly class="form-control" type="text" name="itemID" value="<?php echo($itemID); ?>"/>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input id="itemName" class="form-control" type="text" name="itemName" value="<?php echo($itemName); ?>"required="required" placeholder="name" />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea id="itemDescription" rows="3" class="form-control" type="text" name="itemDescription" required="required" placeholder="description"><?php echo($itemDescription);?></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input id="stockQuantity" class="form-control" type="number" value="<?php echo($stockQuantity); ?>" min="0" max="900" name="stockQuantity" placeholder="qty" required="required" />
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input id="price" class="form-control" type="number" min="0.00" value="<?php echo($price); ?>" max="90000.00" step="0.01" name="price" placeholder="price" required="required" />
                  </div>
                </div>
